...
public class IProjectMapperImpl implements IProjectMapper {
    ...
    public ProjectResponseDto entityToResponse(ProjectEntity entity) {
        ...
        projectResponseDto.setTasksDto( taskEntityListToProjectTaskDtoList( entity.getTaskEntities() ) );
        projectResponseDto.setUsersDto( userEntitySetToProjectUserDtoSet( entity.getUsers() ) );
